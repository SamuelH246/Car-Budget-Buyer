...
2. A list of cars will be shown, select which car you would like to purchase?, or type 'xxx' to quit: 
...
while True:
    ...
    selection_number = int_check("Which car would you like to purchase?, or type '0' to proceed to cart: ", 0, 4)
